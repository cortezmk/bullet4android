...
\title{Wykorzystanie silnika fizycznego Bullet na platformie
mobilnej Android}
...
\begin{document}
    ...
    \bibliographystyle{plainnat}                    %styl bibliografii: w
     %kolejności cytowania, zrozumiały dla pakietu hyperref.sty
     \addcontentsline{toc}{section}{Literatura}      %musi być wyżej niż
     \input{bibliografia.tex}%żeby w~spisie treści był właściwy numer strony
    %koniec bibliografii
